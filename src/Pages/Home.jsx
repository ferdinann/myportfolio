...
const TechStack = memo(({ tech }) => (
  <div className="px-3 py-2 hidden sm:block rounded-full bg-white/5 backdrop-blur-sm border border-white/10 text-sm text-gray-300 hover:bg-white/10 transition-colors">
    {tech}
  </div>
));
...
const WORDS = ["IT Student", "Data & AI Enthusiast"];
const TECH_STACK = ["Tensorflow", "Python", "React", "Flutter"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ferdinann" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ferdinanta/" },
  { icon: Instagram, link: "https://www.instagram.com/ferdinan_ginting28/?hl=id" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Membangun model yang efektif dan efisien untuk memecahkan masalah yang ada.
                </p>
