...
import fgai from "../assets/fgai.png";
import cet from "../assets/cet.png";
import geo from "../assets/geo.png";
import homecheck from "../assets/hc.png";
import firstaid from "../assets/fa.png";
import lapor from "../assets/lapor.png";
import posko from "../assets/posko.png";
...
const projectsData = [
  ...
  },
  {
    ...
    Img: geo,
    Title: "GeoHeal",
    Description: "Deteksi jenis tanah pasca bencana untuk langkah pemulihan yang lebih cepat.",
    Link: "https://geo-heal.vercel.app/",
    Tect_stack: "Python, TensorFlow, huggingface",
    Fitur: ["Deteksi jenis tanah", "Rekomendasi Pemulihan", "Rekomendasi Jenis Tanaman"]
  },
  {
    id: 9,
    Img: homecheck,
    Title: "HomeCheck",
    Description: "Deteksi kerusakan bangunan pasca bencana untuk keamanan ditempati.",
    Link: "https://home-check-sigma.vercel.app/",
    Tect_stack: "Python, TensorFlow, huggingface",
    Fitur: ["Klasifikasi tingkat kerusakan bangunan", "Rekomendasi kelayakan hunian"]
  },
  {
    id: 10,
    Img: firstaid,
    Title: "FirstAidLens",
    Description: "Diagnosis luka & saran pertolongan pertama.",
    Link: "https://first-aid-lens.vercel.app/",
    Tect_stack: "Python, TensorFlow, huggingface",
    Fitur: ["Diagnosis jenis luka via gambar", "Panduan pertolongan pertama (first aid)"]
  },
  {
    id: 11,
    Img: lapor,
    Title: "LaporDarurat",
    Description: "Pelaporan insiden real-time untuk mempercepat informasi sampai ke tim evakuasi.",
    Link: "https://lapor-darurat.vercel.app/",
    Tect_stack: "Python, TensorFlow, huggingface",
    Fitur: ["Form pelaporan insiden real-time", "Klasifikasi jenis insiden (kebakaran, banjir, gempa)"]
  },
  {
    id: 12,
    Img: posko,
    Title: "PoskoLog",
    Description: "Sistem manajemen logistik dan pengumpulan umpan balik (feedback) mengenai kondisi posko bantuan.",
    Link: "https://posko-log.vercel.app/",
    Tect_stack: "Python, TensorFlow, huggingface",
    Fitur: ["Form input masukan kondisi posko", "Analisis kepuasan dan kebutuhan logistik"]
  }
];
